class lecture1 {
   static void swap(Integer a, Integer b) {
      /*
       * !it will not swap the original values because scope of the variables are only
   ...
   public static void main(String[] args) {
       ...
       * here below rahul is the reference variable , means reference to an object of
       * type Student and residing in stack memory
       */
      Student rahul;

      /*
       * !new keyword allocates the memory at run time(dynamically) in heap and return
       * reference to it and this reference is stored in the instance variable
       * 
       ...
       * creation of more than one constructor which have different parameters is
      ...
      // !new concept
      /*
       * below one and two are referring to same object and any change via one of the
       * reference variable will result in the change in original object
       */
       ...
       * 
       * 
       * /here num is an object and this have many properties and known as {wrapper
       * class}
       * Integer num = 10;
       * 
       ...
       * we have to initialize the final variable at the time of declaration otherwise
       * it will give us error
       * it can prevent only primitive data types from changing there value and in the
       * case of non-primitive data types it cannot prevent the datatype from changing
       * value
       */
      ...
      // Kunal = aki; --> not possible because Kunal is already instantiated and
      // allocated memory in the heap and pointing to an object already
      // !in short when a non primitive is final it can assigned only one time and
      // cannot resign it again and again

      // !now we will study about garbage collector
      /*
       * In java you cannot destroy the objects manually but you can tell what to do
 ...
 */
class Student {
   // ! using dot operator these properties can be accessed easily via objects and
   // these below are known as instance variables
   ...
   void changeName(String name) {
      /*
       * in the below condition the compiler will get confused because the name of the
       * parameter and the name of the instance variable inside the class is same and
       * to avoid this confusion we will use this keyword
       */
    ...
    * a constructor is a function of type class which will tell what will happen
    * when an object will be created
    * if you have not created a constructor java will create its own constructor
   ...
   Student(String name, int rollNo, float marks) {
       ...
       * suppose name of the reference variable is rahul then here this will be
       * replaced with "rahul"
       */
   ...
   // !constructor number2
   Student() {
      // here we will call another constructor from this constructor using this
      // keyword

      // *in this case this will be replaced with the name of the class and not with
